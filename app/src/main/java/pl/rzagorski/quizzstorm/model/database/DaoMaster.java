...
import pl.rzagorski.quizzstorm.model.database.AnswerDao;
import pl.rzagorski.quizzstorm.model.database.QuestionDao;
import pl.rzagorski.quizzstorm.model.database.QuizResultDao;
...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        QuizRatesDao.createTable(db, ifNotExists);
        RateDao.createTable(db, ifNotExists);
        AnswerDao.createTable(db, ifNotExists);
        QuestionDao.createTable(db, ifNotExists);
        QuizResultDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        QuizRatesDao.dropTable(db, ifExists);
        RateDao.dropTable(db, ifExists);
        AnswerDao.dropTable(db, ifExists);
        QuestionDao.dropTable(db, ifExists);
        QuizResultDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(QuizRatesDao.class);
        registerDaoClass(RateDao.class);
        registerDaoClass(AnswerDao.class);
        registerDaoClass(QuestionDao.class);
        registerDaoClass(QuizResultDao.class);
